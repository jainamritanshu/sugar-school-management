jQuery(document).ready(function($){
  ...
  function getInitialData() {
    ...
    $.ajax({
      ...
      for(key in user){
        if($.inArray(key,['name','address','email','contact','principal'])!=-1){
          baseEle +="<div class='row detail'><div class='col-xs-2 col-xs-offset-1'> <h5><strong style='text-transform: capitalize;'>"+key+"</strong></h5> </div> <div class='col-xs-8 col-xs-offset-1 '> <h5 id="+key+">"+user[key]+"</h5> </div></div>";
        }
      }
  ...
  $('#details').click(function(){
    ...
    baseEle="";
    for(key in user){
      baseEle+="<div class='row detail'><div class='col-xs-2 col-xs-offset-1 col-md-offset-3'> <h5><strong style='text-transform:capitalize'>"+key.replace("_"," ")+"</strong></h5> </div> <div class='col-xs-8 col-xs-offset-1 col-md-6'> <h5 id="+key+">"+user[key]+"</h5> </div></div>";
    }
